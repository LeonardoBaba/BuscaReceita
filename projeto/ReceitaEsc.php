...
echo("	</div>");
#Nome
echo("	<div class=\"Retangulo_7\"><div class=\"CADASTRO_DE_USUARIO\">EXCLUIR $receita[txnomereceita]</div></div>");
echo("	<div class=\"row\">");
...
echo("<form action='./ReceitaDel.php' method='POST'>");
echo("<input type='hidden' name='cpreceita' value='$idreceita'>");
echo("<input type='submit' class=\"button red\" value='Enviar'>");
printf("</div></div>");
