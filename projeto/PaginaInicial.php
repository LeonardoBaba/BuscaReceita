...
$query = "SELECT * FROM receita ORDER BY qtfavoritos DESC LIMIT 6";
...
echo("	</div>");
echo("	</div>");
echo("	<div class=\"Retangulo_7\"><div class=\"CADASTRO_DE_USUARIO\">BEM-VINDO</div></div>");
...
#busca receita por receita

$c = 310;
while ($REG = mysqli_fetch_array($sql)){
    printf("<div class='R_11'><img src='./imagem/$REG[tximagem]' class='square'></div>");//imagem da receita
    printf("<p class='k18' style='font-size:30px;position:absolute;left:570px;top:$c'>$REG[txnomereceita]</p>");//nome da receita
    printf("<form action='./PaginaReceita.php' method='POST'>");
    printf("<input type='submit' name='cpreceita' class='button red' style='font-size:20px;position:relative;left:220px;top:-35px' value='$REG[idreceita]'><br>");
    printf("<form>");
	$c = $c+230;
}	
