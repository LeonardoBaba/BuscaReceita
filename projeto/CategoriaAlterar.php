...
echo("	</div>");
?>
	<div class="Retangulo_7"><div class="CADASTRO_DE_USUARIO">SELECIONE A CATEGORIA À ALTERAR</div></div>
...
<?php
  ...
  printf("<br><br><p class=\"t1\"><form action='./CategoriaAlt.php' method='POST'>\n");
