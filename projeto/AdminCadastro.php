...
echo("	</div>");
?>
	<div class="Retangulo_7"><div class="CADASTRO_DE_USUARIO">CADASTRO DE ADMINISTRADOR</div></div>
	...
	<div class="column middle">
		<?php
	printf("<form action='./AdminIns.php' method='POST' enctype='multipart/form-data'>
	<p class=\"t1\">
	<br><br>
		<span>NOME COMPLETO:</span>
		<input type='text' name='nome'  size=80%% maxlength=45>
		<span></span><br>
		DATA DE NASCIMENTO
		<input type='date' name='dtnascimento'>
		
		<p class=\"t1\" style=\"position: relative\">SEXO
		<select name='sexo'><option value='M'>Masculino</option><option value='F'>Feminino</option></select>
		
		<br>
		<span>ENDEREÇO DE E-MAIL</span>
		<input type='text' name='email' size=80%% maxlength=45>
		
		<span>NOME DE USUÁRIO</span>
		<input type='text' name='user' size=80%% maxlength=45>
		<span>SENHA:</span>
		<input type='password' name='senha' size=80%% maxlength=20>
		
		<span>CONFIRMAR SENHA</span>
		<input type='password' name='senha2' size=80%% maxlength=20>
		...
		?>
		<br><br>
		<input type='reset'  class="button gray" value='CANCELAR'>
