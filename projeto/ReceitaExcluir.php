...
<?php
  ...
  $cmdsql="SELECT * FROM receita ORDER BY idreceita";
  printf("<br><br><p class=\"t1\"><form action='./ReceitaEsc.php' method='POST'>\n");
  $execcmd=mysqli_query($link,$cmdsql);
  printf("<span>SELECIONE A RECEITA PARA SER DELETADA</span>");
