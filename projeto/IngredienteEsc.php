...
<div class="header">
	...
	<div class="Retangulo_7"><div class="CADASTRO_DE_USUARIO">EXCLUIR INGREDIENTE</div></div>
...
printf("	<br><br><p class=\"t1\"><form action='./IngredienteDel.php' method='POST'>\n");
printf("		");
printf("		Código<br>");
printf("		<input type='hidden' name='idingrediente' value=\"$reg[idingrediente]\">$reg[idingrediente]<br>");
printf("		NOME DO INGREDIENTE:<br>\n");
printf("		$reg[txnomeingrediente]<br>\n");
