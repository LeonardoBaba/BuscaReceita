...
echo("	</div>");
?>
	<div class="Retangulo_7"><div class="CADASTRO_DE_USUARIO">CADASTRO DE CATEGORIA</div></div>
	...
	<form action='./CategoriaIns.php' method='POST'>
	<p class="t1">
	<br><br>
		<span>NOME DA CATEGORIA:</span>
		<input type='text' name='nomecategoria'  size=80% maxlength=45>
		<span></span><br>
		<br><br>
		<input type='reset'  class="button gray" value='LIMPAR'>
