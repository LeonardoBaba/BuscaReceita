...
<div class="header">
	...
	<div class="Retangulo_7"><div class="CADASTRO_DE_USUARIO">SELECIONE O INGREDIENTE À ALTERAR</div></div>
...
<?php
  ...
  printf("<br><br><p class=\"t1\"><form action='./IngredienteAlt.php' method='POST'>\n");
