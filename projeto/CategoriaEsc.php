...
echo("	</div>");
?>
	<div class="Retangulo_7"><div class="CADASTRO_DE_USUARIO">EXCLUIR CATEGORIA</div></div>
...
printf("	<br><br><p class=\"t1\"><form action='./CategoriaDel.php' method='POST'>\n");
printf("		");
printf("		Código<br>");
printf("		<input type='hidden' name='idcategoria' value=\"$reg[idcategoria]\">$reg[idcategoria]<br>");
printf("		NOME DA CATEGORIA:<br>\n");
printf("		$reg[txnomecategoria]<br>\n");
